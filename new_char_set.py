{
    ...
    L: [Path(start=(0, 0), end=(0, 0)), Path(start=(0, 0), end=(0, h))],
    M: [
        Path(start=(0, 0), end=(0, h)),
    ...
    V: [Path(start=(0, 0), end=(w/2, 0)), Path(start=(w/2, 0), end=(w, h))],
    W: [
        Path(start=(0, 0), end=(w/4, 0)),
    ...
    X: [Path(start=(0, 0), end=(w, h)), Path(start=(w, h), end=(w, 0))],
    Y: [
    ...
    Z: [
     ...
     : [],
    !: [Path(start=(0, 0), end=(w/2, h/5)), Path(start=(w/2, h/5), end=(w/2, 0))],
    ?: [],
    DEBUG: [
        Path(start=(0, 0), end=(0, h)),
        Path(start=(0, h), end=(w, h)),
